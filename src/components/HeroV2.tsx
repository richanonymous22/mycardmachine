...
export const HeroV2 = () => {
  return <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20 md:pt-24 pb-12 md:pb-16">
      {/* Subtle Grid Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          delay: 0.3
            ...
            icon: CheckCircle2,
            text: "Expert Support"
          }].map((item, i) => <div key={i} className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm md:text-base">
          ...
          delay: 0.4
            ...
            <Button size="lg" className="bg-gradient-to-r from-primary to-primary-hover shadow-glow hover:shadow-xl transition-all text-base md:text-lg px-8 md:px-10 py-6 md:py-7 group" onClick={() => {
